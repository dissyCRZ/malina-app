...
import 'package:malina_mobile_app/features/records/presentation/pages/add_record_select_date_sheet.dart';
import '../../../food_shop/data/models/place.dart';

Future<dynamic> addRecordSelectDateBottomSheet(
  ...
  return showModalBottomSheet(
    ...
    builder: (context) => MultiBlocProvider(
      ...
      child: AddRecordSelectDateSheet(
